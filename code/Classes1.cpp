...
public:
 ...
 void printStudentInfo()
	{
		cout << id_ << endl << name_ << endl << gpa_ << endl << address_ << endl << endl;
	}
...
int main()
{
	...
	st1.address_ = "Amman";
	st1.gpa_ = 90.0;
	//cout << st1.id_ << endl << st1.name_ << endl << st1.gpa_ << endl << st1.address_ << endl << endl;
	...
	st2.address_ = "Salt";
	st2.gpa_ = 70.0;
	//cout << st2.id_ << endl << st2.name_ << endl << st2.gpa_ << endl << st2.address_ << endl << endl;
